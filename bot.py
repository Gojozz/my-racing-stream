...
def rotate_after_race(eliminated_name):
    ...
    # Cari pemain berdasarkan nama yang benar-benar keluar.
...
def start_bot():
    ...
    # Server rotasi berjalan di thread terpisah.
    threading.Thread(
    ...
    while True:
        ...
        try:
            if not chat.is_alive():
                print("[CHAT] Koneksi chat berhenti.")
                print("[CHAT] Mencoba reconnect dalam 5 detik...")
                time.sleep(5)
